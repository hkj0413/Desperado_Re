...
class MainMenuScene(Scene):
    ...
    def _activate_selected(self) -> None:
        ...
        if action == 'play':
            ...
            self.app.scene_manager.change(PlayScene, stage_id='prototype_stage')
        elif action == 'guide':
    ...
    def draw(self, screen: pygame.Surface) -> None:
        ...
        title = title_font.render('Desperado Re:', True, (235, 218, 158))
        subtitle = subtitle_font.render('2D Adventure', True, (180, 192, 214))
        ...
        for index, (label, _) in enumerate(self.MENU_ITEMS):
            ...
            color = (255, 238, 166) if selected else (218, 224, 235)
            prefix = '▶  ' if selected else '    '
            text = menu_font.render(prefix + label, True, color)
            screen.blit(text, text.get_rect(center=(width // 2, 390 + index * 58)))

        footer = subtitle_font.render('↑ ↓ 선택   Enter 결정   Esc 종료', True, (150, 160, 178))
